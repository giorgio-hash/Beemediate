...
public class Order {
	 ...
	 */
	//@ public normal_behaviour
	//@ ensures \result == (!articleNumber | !quantityMeasure | (!deliveryDateContent || !deliveryDate));
	...
	//@ ensures \result == (!customerNumber | !deliveryLocationNumber | !deliveryDateContent | quantity == QuantityFieldValue.FLOAT_WITH_COMMA | quantity == QuantityFieldValue.NAN);
